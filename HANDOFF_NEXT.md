...
**Current through 2026-08-12. This is the entry point for a new development session.**
...
4. [FINDINGS.md](FINDINGS.md) and [HANDOFF.md](HANDOFF.md) — lookup references for ROM
...
- Ordinary extracted script: **1,404 of 1,422 records translated**. The other 18 are
...
| Build | SHA-256 |
|---|---|
| `build/shiren_en.gb` | `b5b45c3c95a3ff1305d36c0fbf1b538097f5fae7f3a5cf01146ac67ddb3a260f` |
| `build/shiren_en_shuffle.gb` | `c9842fec9c9ff02e2a9eb24eab5ecf64f5c2dda7cfc55c3776a93de48c628be1` |
| `build/shiren_en_redirect_all.gb` | `7b8153b7d19a7e578f77fd872cbd7dd2039708599c79b9d592fb2b9ffa80591f` |
...
3. **V6 release freeze.** When the playthrough is accepted, stop changing font, text,
   graphics and geometry; run the entire battery documented in README §5, verify a clean
...
4. **Optional research only:** replace legacy runtime-substitution warning estimates with
   an exact producer-to-template census. There is no known physical fit failure, so this
   must not delay the release candidate or cause good English to be shortened merely to
   silence a warning.

## Non-negotiable engineering rules

- `sh build.sh` is only the normal-build gate. A release claim requires the README’s full
  normal/shuffled/redirect-all matrix and a fixture preflight; missing fixtures otherwise
  skip silently.
